    ...
    public class ProductsProvider : IProductsProvider
    {
        ...
        private void SeedData()
        {
            if (!dbContext.Products.Any()) 
            {
                ...
                dbContext.Products.Add(new Db.Product { Id = 3, Name = "Central Unit", Price = 200, Inventory = 105 });
                dbContext.Products.Add(new Db.Product { Id = 4, Name = "Screen", Price = 210, Inventory = 106 });
                dbContext.Products.Add(new Db.Product { Id = 5, Name = "Camera", Price = 29, Inventory = 100 });
